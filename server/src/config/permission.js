...
export const permissionMap = {
  ...
  // ========================================
  // Public routes
  'GET /suggestions': null, // Public
  'GET /suggestions/:algorithm': null, // Public
  'GET /suggestions/popular': null, // Public
  'GET /suggestions/random': null, // Public
  
  // Protected routes
  'GET /suggestions/followed-vendors': 'products_read',
  'GET /suggestions/recently-viewed': 'products_read',
  'DELETE /suggestions': 'products_read',
  'GET /suggestions/stats': 'products_read',
  ...
  'PATCH /vendors/vendor/profile': 'vendors_update',
  'GET /vendors/:id/profile': 'vendors_read',
  'POST /vendors/initialize-onboarding': 'vendors_update',
  ...
  'PATCH /vendors/:id/logo/approve': 'vendors_update',
  'PATCH /vendors/:id/logo/reject': 'vendors_update',
  ...
  // ========================================
  // VENDOR MESSAGE ROUTES
  // ========================================
  'POST /messages/vendor': 'support_create',
  'GET /messages/vendor': 'support_read',
  'GET /messages/vendor/:id': 'support_read',
  'PATCH /messages/vendor/:id': 'support_update',
  'DELETE /messages/vendor/:id': 'support_update',
  'GET /messages/admin/all': 'support_read',
  'GET /messages/admin/:id': 'support_read',

  // ========================================
  // PAYOUT ROUTES (Admin)
  // ========================================
  'POST /payouts/initiate': 'payouts_manage',
...
export const publicRoutes = [
  ...
  'GET /variants/products/:productId/colors',
