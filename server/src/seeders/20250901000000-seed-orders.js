...
// Date range for order generation: October 2025 to current date
const ORDER_START_DATE = new Date('2025-10-01T00:00:00');
const ORDER_END_DATE = new Date(); // Current date: 2025-12-17
    ...
    try {
      ...
      for (
        ...
        for (let i = batchStart; i < batchEnd; i++) {
          ...
          // Generate order date within October 2025 to current date range
          const orderDate = between({ 
